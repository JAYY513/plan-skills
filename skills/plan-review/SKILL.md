...
4. **启动下一里程碑**：将 ▶ 移到下一个里程碑，结合其验收标准 + 上一步的 FINDINGS + 遗留问题，反推出第一批任务（含必要的调研探针，带时间盒和 DoD）录入 TASKS.md，确保「进行中」+「已拆好」≥ 2 个；MVP 桶已清空时，从 P0 桶取下一里程碑内容（并在 ROADMAP 中标注该里程碑属于哪个桶）
- 提示用户庆祝一下
